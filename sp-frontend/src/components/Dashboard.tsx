...
export default function Dashboard({
  ...
  const profileImage =
    assets[0]?.imageUrl || "https://via.placeholder.com/120";
      ...
      <div className="flex-1 max-w-4xl mx-auto mt-20 px-6 space-y-8">
        ...
        <div className="flex justify-center gap-4 mt-8 flex-wrap">
          {role === "admin" && (
            <Link
              to="/admin"
              className="bg-red-600 px-6 py-3 no-underline rounded-xl text-white hover:bg-red-500 transition flex items-center gap-2 shadow-md hover:shadow-lg"
            >
              <svg
